...
import 'package:radargass/pages/PilihPaket/scroll_daftarpaket.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Expanded(
              child: SingleChildScrollView(child: ScrollDaftarPaket())),
          Positioned(
            top: 0,
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: IconButton(
                    onPressed: () {
                      BlocProvider.of<AppsCubits>(context).GoPilihPaket();
                    },
                    icon: Icon(
