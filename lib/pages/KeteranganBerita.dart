...
class OpenBerita extends StatefulWidget {
  const OpenBerita({Key? key}) : super(key: key);

  @override
  State<OpenBerita> createState() => _OpenBeritaState();
}

class _OpenBeritaState extends State<OpenBerita> with TickerProviderStateMixin {
  @override
          ...
          if (state is ScrollBerita) {
            return Container(
              ...
              child: Stack(children: [
                Expanded(
                    child: SingleChildScrollView(child: ScrollNews())),
                Positioned(
                  left: 10,
                  top: 30,
                  child: Row(
