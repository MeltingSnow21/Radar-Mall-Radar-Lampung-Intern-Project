...
class ScrollPilihPaketBelumLogin extends StatefulWidget {
  const ScrollPilihPaketBelumLogin({Key? key}) : super(key: key);

  @override
  State<ScrollPilihPaketBelumLogin> createState() => _ScrollPilihPaketBelumLoginState();
}

class _ScrollPilihPaketBelumLoginState extends State<ScrollPilihPaketBelumLogin> {
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      AppLargeText(text: " Pilih Paket", size: 13,color:Colors.white,),
                                    ],
                                  ),
                                ],
                              ),
