...
class DisekitarmuPage extends StatefulWidget {
  const DisekitarmuPage({Key? key}) : super(key: key);

  @override
  State<DisekitarmuPage> createState() => _DisekitarmuPageState();
}

class _DisekitarmuPageState extends State<DisekitarmuPage> with TickerProviderStateMixin {
  @override
                          ...
                          children : [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  SizedBox(height:35,),
                                  AppLargeText(text: "Disekitarmu", color: AppColors.mainColor,size: 22)
